...
sed 's/TIME/'$time'/g' gmtFiles/sigma3.gmt > gmtFiles/tmp.gmt; \
    gmtPlot gmtFiles/tmp.gmt
sed 's/TIME/'$time'/g' gmtFiles/b3.gmt > gmtFiles/tmp.gmt; \
    gmtPlot gmtFiles/tmp.gmt
sed 's/TIME/'$time'/g' gmtFiles/w3.gmt > gmtFiles/tmp.gmt; \
    gmtPlot gmtFiles/tmp.gmt
sed 's/TIME/'$time'/g' gmtFiles/P3.gmt > gmtFiles/tmp.gmt; \
    gmtPlot gmtFiles/tmp.gmt
...
ln -sf ../gmtFiles/results3.lyx $time/results3.lyx
lyx --export pdf $time/results3.lyx 1> /dev/null
pdfCrop $time/results3.pdf
ev $time/results3.pdf
