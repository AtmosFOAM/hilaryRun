...
gmt psbasemap -JX15c/10c -R-1/1/0/1\
          -Ba0.5g10f0.5:"w (m/s)":/a0.2f0.2:"z (m)": -K > $outFile
gmt psxy -J -R -A -h1 -Sc3p -O -K \
    -CcolourScale.cpt $case/$time/bw.xyz  >>$outFile

# Colorbar
gmt psscale -CcolourScale.cpt -S -K -O  -D15.3c/5c/10c/0.5c  >> $outFile
...
gmt makecpt -C$GMTU/colours/red_grey_blue.cpt -D -T-1/1/0.1 > colourScale.cpt
gmt set MAP_FRAME_AXES WeSn
gmt psbasemap -JX15c/10c -R-0.5/0.5/0/1\
          -Ba0.1g1f0.1:"b (m s@+-2@+)":/a0.2f0.2:"z (m)": -K > $outFile
