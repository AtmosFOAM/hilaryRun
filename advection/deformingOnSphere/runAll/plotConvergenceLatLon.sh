...
cases="weakDeformation/MPDATA_latLonRotated_2gauge_adv"
inputFiles=''
...
echo 360 .5 0.001 0.001 >> plots/1st2ndOrder.dat
echo 36   5 0.01 0.1 >> plots/1st2ndOrder.dat
