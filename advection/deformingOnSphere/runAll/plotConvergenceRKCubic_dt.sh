...
cases="fullDeformation/RK3cubic_cubedSphere_c025
       fullDeformation/RK3cubic_cubedSphere_c05
       fullDeformation/RK3cubic_cubedSphere_c1
       fullDeformation/RK3cubic_cubedSphere_c2
       fullDeformation/RK3cubic_cubedSphere_c5
       fullDeformation/RK3cubic_cubedSphere_c10
       "

legends=("cubed sphere" "1st/2nd order")
data=plots/RK3cubic_cubedSphere_c.dat
res=cube_60
...
inputFiles=($data
            ...
            plots/1st2ndOrder.dat)
outFile=plots/l2errorRK3Cubic_dt.eps
col=(3 2 3)
colx=(1 1 1)
pens=("1p,black"
