...
//{{{ begin codeInclude
#line 33 "/home/hilary/OpenFOAM/hilary-10/run/vSlice/hillWaves/hydro/dt20_expG_impU_nonHydroRef/0/Exnerp/boundaryField/ground"
#include "specie.H"
...
//{{{ begin code
    #line 47 "/home/hilary/OpenFOAM/hilary-10/run/vSlice/hillWaves/hydro/dt20_expG_impU_nonHydroRef/0/Exnerp/boundaryField/ground"
const dictionary& environmentalProperties
            ...
            const fvPatchField<scalar>& thetap
                 = patch().lookupPatchField<volScalarField, scalar>("thetap");
