...
cp -r $case/../singleColumn_Pi_1e4_divTransfer/0 $case

# Multiply sigma.buoyant by 2
sumFields -case $case 0 sigma.buoyant 0 sigma.buoyant 0 sigma.buoyant -scale0 2 -scale1 0
